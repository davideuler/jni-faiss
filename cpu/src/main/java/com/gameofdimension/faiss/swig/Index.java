...
public class Index {
  ...
  public void compute_residual_n(long n, SWIGTYPE_p_float xs, SWIGTYPE_p_float residuals, SWIGTYPE_p_long_long keys) {
    swigfaissJNI.Index_compute_residual_n(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(xs), SWIGTYPE_p_float.getCPtr(residuals), SWIGTYPE_p_long_long.getCPtr(keys));
  }
