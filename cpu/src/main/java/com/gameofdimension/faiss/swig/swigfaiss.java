...
public class swigfaiss implements swigfaissConstants {
  ...
  public static java.math.BigInteger get_cycles() {
  ...
  public static void pairwise_indexed_L2sqr(long d, long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long ix, SWIGTYPE_p_float y, SWIGTYPE_p_long_long iy, SWIGTYPE_p_float dis) {
    swigfaissJNI.pairwise_indexed_L2sqr(d, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(ix), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(iy), SWIGTYPE_p_float.getCPtr(dis));
  }

  public static void pairwise_indexed_inner_product(long d, long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long ix, SWIGTYPE_p_float y, SWIGTYPE_p_long_long iy, SWIGTYPE_p_float dis) {
    swigfaissJNI.pairwise_indexed_inner_product(d, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(ix), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(iy), SWIGTYPE_p_float.getCPtr(dis));
  }
  ...
  public static void int64_rand_max(SWIGTYPE_p_long_long x, long n, java.math.BigInteger max, long seed) {
    swigfaissJNI.int64_rand_max(SWIGTYPE_p_long_long.getCPtr(x), n, max, seed);
  }
  ...
  public static void search_with_parameters(Index index, long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, IVFSearchParameters params, SWIGTYPE_p_long_long nb_dis) {
    swigfaissJNI.search_with_parameters__SWIG_0(Index.getCPtr(index), index, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), IVFSearchParameters.getCPtr(params), params, SWIGTYPE_p_long_long.getCPtr(nb_dis));
  }
  ...
  public static void search_with_parameters(Index index, long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, IVFSearchParameters params) {
    swigfaissJNI.search_with_parameters__SWIG_1(Index.getCPtr(index), index, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), IVFSearchParameters.getCPtr(params), params);
  }
